                        ...
                        {!user && (
                            <div className="login-prompt" style={{
                                ...
                                <p style={{ margin: 0, color: '#5a5a5a' }}>
                                    Please <a href="/login" style={{ color: '#a52a2a', textDecoration: 'none', fontWeight: '600' }}>log in</a> to save your order history
                                </p>
                            </div>
                        )}
                    </div>
            ...
            {showAuthModal && (
                <div className="modal-overlay" onClick={closeAuthModal}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="modal-message">
                            Please sign in to your account to place an order. This helps us track your orders and provide better service.
                        </p>
                        <div className="modal-actions">
                            <button onClick={redirectToLogin} className="modal-action-btn primary">
                                Sign In
                            </button>
                            <button onClick={closeAuthModal} className="modal-action-btn secondary">
                                Cancel
                            </button>
                        </div>
                    </div>
